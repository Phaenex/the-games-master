...
// intake tool: candidates stay outside the served asset tree until they pass a
// visual and size gate.
...
for (const input of files) {
  ...
  const stem = basename(input, extname(input)).replace(/[^a-z0-9_-]+/gi, '-').toLowerCase();
