...
export const UNITY_ROOT = path.join(homedir(), 'GamesMaster-Unity');
...
export function syncUnityScenes(registry, {
  ...
  const unmanaged = existsSync(unityRoot)
    ? walkFiles(unityRoot).filter((relative) => isProjectOwnedUnityFile(relative) &&
