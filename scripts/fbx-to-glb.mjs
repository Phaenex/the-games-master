...
await page.goto(`http://127.0.0.1:${port}/scripts/fbx-to-glb.html`, { waitUntil: 'networkidle' });
await page.waitForFunction(() => window.THREE && window.__FBX2GLB && THREE.FBXLoader && THREE.GLTFExporter);
