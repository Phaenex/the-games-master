...
const unityRoot = path.join(homedir(), 'GamesMaster-Unity');
...
try {
  ...
  console.log(`✓ generated Unity scene scaffold compiles against ${version} (${generated.size} files, ${spec.shots} shots)`);
} finally {
