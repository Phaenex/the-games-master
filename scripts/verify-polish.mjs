...
check('crickets-armed', amb.ambOn && amb.hasCrickets, `ambOn=${amb.ambOn} crickets=${amb.hasCrickets} paused=${amb.paused} baseVol=${amb.baseVol}`);
...
console.log('\n=== POLISH VERIFY:', pass?'ALL PASS':'FAILURES PRESENT', '===');
