...
```
Engine separation        [█████████░░░░░░░░░░░]  45%  remote package proof, learning ledger, and shared session proven; legacy migration remains
Boundary audit           [████████████████████] 100%  63 runtime files classified and ratcheted
...
Versioned engine repo    [████████████████████] 100%  private v0.2.0 resolved through Git UPM and built in a clean consumer
```
...
| ENG5 | Move the package to a versioned repository and prove remote consumption | DONE 2026-08-19 | private `v0.2.0` resolved to exact commit through Git UPM, compiled without a Games Master assembly, and produced a clean macOS player |
...
Wager                    [███░░░░░░░░░░░░░░░░░]  15%  deterministic rules, match/intervention snapshot core and the house sovereign economy are proven; controller, save, input and player-facing game remain
...
| SD4 | Build Wager | WIP | every seed permutation, economy, clause swap and no-soft-lock proof |
